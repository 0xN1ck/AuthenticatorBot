...
from infrastructure.database.repo.markets import MarketRepo
...
class RequestsRepo:
    ...
    def markets(self) -> MarketRepo:
        """
        The Market repository sessions are required to manage market operations.
        """
        return MarketRepo(self.session)
